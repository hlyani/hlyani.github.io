...
```
wget -O /usr/local/go1.23.4.linux-amd64.tar.gz https://golang.org/dl/go1.23.4.linux-amd64.tar.gz
tar -C /usr/local -zxvf /usr/local/go1.23.4.linux-amd64.tar.gz
